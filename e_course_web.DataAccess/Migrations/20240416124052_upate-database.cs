        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicVideo = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamHistorys_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamHistorys_Exams_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamLessons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamLessons_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExamLessonId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamQuestions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamQuestions_ExamLessons_ExamLessonId",
                        column: x => x.ExamLessonId,
                        principalTable: "ExamLessons",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamHistorys_ExamId",
                table: "ExamHistorys",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamHistorys_UserId",
                table: "ExamHistorys",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamLessons_ExamId",
                table: "ExamLessons",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamQuestions_ExamLessonId",
                table: "ExamQuestions",
                column: "ExamLessonId");
